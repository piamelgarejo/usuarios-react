    ...
    <div className="navbar bg-secondary shadow-sm">
      ...
      <div className="flex-none">
        <ul className="menu menu-horizontal px-1">
          <li><NavLink className={({isActive}) => (isActive ? "active" : "no-active")} to={"/"}>Inicio</NavLink></li>
          {/* <li><NavLink className={({isActive}) => (isActive ? "active" : "")} to={"/detalles"}>Detalles usuarios</NavLink></li> */}
        </ul>
      </div>
    </div>
